...
const door = new THREE.Mesh(
  new THREE.PlaneBufferGeometry(2, 2, 32, 32),
  new THREE.MeshStandardMaterial({
...
// My Solution To Randomly Generate
// const maxZ = floor.geometry.parameters.height;
// const maxX = floor.geometry.parameters.width;

// const minZ = walls.geometry.parameters.depth;
// const minX = walls.geometry.parameters.width;

// for (let i = 0; i < 20; i++) {
//   let positionX = (Math.random() - 0.5) * maxX;
//   let positionZ = (Math.random() - 0.5) * maxZ;

//   if (Math.abs(positionX) <= minX) {
//     if (positionX < 0) {
//       positionX -= minX;
//     }
//     if (positionX >= 0) {
...
//   grave.position.set(
//     positionX,
//     grave.geometry.parameters.height / 2,
//     positionZ
//   );
//   graves.add(grave);
// }
...
for (let i = 0; i < 50; i++) {
  ...
  const radius =
    walls.geometry.parameters.width -
    1 +
    Math.random() *
      (floor.geometry.parameters.width / 2 - walls.geometry.parameters.width);
  const x = Math.sin(angle) * radius;
  const z = Math.cos(angle) * radius;

  const grave = new THREE.Mesh(graveGeometry, graveMaterial);

  grave.position.set(x, grave.geometry.parameters.height / 3, z);
...
doorLight.position.set(
  door.position.x,
  walls.geometry.parameters.height - 0.01,
  door.position.z + 0.2
);
house.add(doorLight);
 ...
 * Ghosts
 */
const ghost1 = new THREE.PointLight("#32633f", 2, 3);
const ghost2 = new THREE.PointLight("#377380", 2, 3);
const ghost3 = new THREE.PointLight("#89faa7", 2, 3);
